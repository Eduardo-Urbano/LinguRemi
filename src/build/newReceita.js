...
adicionarReceita.addEventListener('click', async () => {
    ...
    const descricaoReceitaBlog = document.getElementById('descReceita').value;
    const ingredientesReceitaBlog = document.getElementById('ingReceita').value;
    const preparoReceitaBlog = document.getElementById('preparoReceita').value;
    const tempoReceitaBlog = document.getElementById('tempoReceita').value;
    const file = fotoInput.files?.[0];
    if (!file) {
